...
// node_modules/tools-vue3/dist/tools-vue3.js
var require_tools_vue3 = __commonJS({
  "node_modules/tools-vue3/dist/tools-vue3.js"(exports, module) {
    !function(e, t) {
      "object" == typeof exports && "undefined" != typeof module ? t(exports, require_vue()) : "function" == typeof define && define.amd ? define(["exports", "vue"], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self)["tools-vue3"] = {}, e.vue);
    }(exports, function(e, t) {
      "use strict";
      var _a, _b, _c;
      const n = "__scopeObjFun";
      const o = (e2) => Array.isArray(e2) ? e2.map((e3) => e3 instanceof RegExp ? e3 : new RegExp(e3)) : e2 instanceof RegExp ? [e2] : e2 ? [new RegExp(e2)] : [];
      e.CRouter = (_a = class {
      }, __publicField(_a, "init", (e2) => {
        const t2 = e2.root || "/src/views";
        if (!e2.modules)
          throw new Error("modules is required");
        const n2 = e2.modules, r = {}, s = o(e2.excludeReg);
        Object.entries(n2).forEach(([e3, n3]) => {
          if (!s.some((t3) => t3.test(e3))) {
            const o2 = e3.replace(t2, "").replace(".vue", "");
            r[o2] = { value: n3, status: true };
          }
        });
        const c = e2.children || [], i = e2.themeTag || "-", u = [], a = (e3 = true) => Object.keys(r).filter((t3) => {
          const n3 = r[t3].status === e3, o2 = t3.substring(t3.lastIndexOf("/") + 1).includes(i);
          return n3 && !o2;
        }), l = e2.pathHook || ((e3) => e3), p = (t3) => {
          var _a2;
          return l(((_a2 = e2.alias) == null ? void 0 : _a2[t3]) || t3);
        };
        if (c.length) {
          const e3 = (t3) => {
            if (t3.children = t3.children || [], t3.childrenList && t3.childrenList.forEach((e4) => {
              r[e4] && (t3.children.push({ path: p(e4), component: e4 }), r[e4].status = false);
            }), t3.children && t3.children.forEach((t4) => {
              e3(t4);
            }), t3.component && (t3.path || (t3.path = p(t3.component)), t3.component = t3.component, r[t3.component].status = false), t3.childrenReg) {
              const e4 = o(t3.childrenReg);
              a().forEach((n3) => {
                e4.some((e5) => e5.test(n3)) && (t3.children.push({ path: p(n3), component: n3 }), r[n3].status = false);
              });
            }
          };
          for (let t3 = 0; t3 < c.length; t3++) {
            const n3 = c[t3];
            r[n3.component] && (e3(n3), u.push(n3));
          }
        }
        a().forEach((e3) => {
          u.push({ path: p(e3), component: e3 }), r[e3].status = false;
        }), u.unshift(...e2.init || []);
        var f, d;
        return f = u, d = e2.theme || "default", ObjectUtil.getObjectByChildren(f, (e3) => {
          e3.path && e3.component && (e3.component = (n2 == null ? void 0 : n2[`${t2}${e3.component}${i}${d}.vue`]) ?? (n2 == null ? void 0 : n2[`${t2}${e3.component}.vue`]));
        }), u;
      }), _a), e.CVue3 = (_b = class {
      }, __publicField(_b, "onDispose", (e2) => {
        var _a2, _b2;
        const n2 = t.getCurrentInstance();
        let o2 = (_b2 = (_a2 = n2.vnode.el) == null ? void 0 : _a2.parentElement) == null ? void 0 : _b2.parentElement, r = false;
        const s = setInterval(() => {
          var _a3, _b3;
          if (r)
            return void clearInterval(s);
          const t2 = (_b3 = (_a3 = n2.vnode.el) == null ? void 0 : _a3.parentElement) == null ? void 0 : _b3.parentElement;
          return void 0 === o2 && (o2 = t2), o2 && !t2 ? (clearInterval(s), void e2()) : void 0;
        }, 50);
        t.onUnmounted(() => {
          r = true, e2();
        });
      }), __publicField(_b, "createCom", (e2) => {
        let n2 = e2.domOrIdOrClass || document.body;
        "string" == typeof n2 && (n2 = document.querySelector(n2));
        const o2 = (...e3) => {
          r.unmount(), r = void 0, e3.forEach((e4) => {
            e4 && n2.removeChild(e4);
          }), n2.removeChild(s);
        };
        e2.props || (e2.props = {}), e2.props.remove = o2;
        let r = t.createApp(e2.component, e2.props);
        const s = document.createElement("div");
        return e2.beforeMount && e2.beforeMount(r), r.mount(s), e2.first ? n2.insertBefore(s, n2.firstChild) : n2.appendChild(s), { vm: r, remove: o2 };
      }), _b), e.Scope = (_c = class {
      }, __publicField(_c, "setConf", (e2, o2) => {
        o2 || "string" == typeof e2 || (o2 = e2, e2 = "conf");
        const r = t.getCurrentInstance();
        let s = o2;
        if ("function" != typeof s && (s = () => o2), r) {
          let t2 = r[n];
          t2 || (t2 = []), t2.push({ key: e2, fun: s }), r[n] = t2;
        }
      }), __publicField(_c, "getConf", (e2, o2) => {
        e2 ? "number" == typeof e2 && (o2 = e2, e2 = "conf") : e2 = "conf", o2 || (o2 = 1);
        let r = t.getCurrentInstance(), s = 0, c = () => null;
        for (; r = r.parent; ) {
          const t2 = r[n];
          if (t2)
            for (let n2 = 0; n2 < t2.length; n2++) {
              const r2 = t2[n2];
              if (r2.key === e2 && (s++, c = r2.fun, s === o2))
                return r2.fun();
            }
        }
        return c();
      }), __publicField(_c, "CEventBean", null), __publicField(_c, "Event", () => {
        if (!_c.CEventBean)
          return null;
        const e2 = t.getCurrentInstance(), n2 = new _c.CEventBean();
        return n2.vm = () => () => !e2.isUnmounted, n2;
      }), __publicField(_c, "TimerBean", null), __publicField(_c, "Timer", () => {
        if (!_c.TimerBean)
          return null;
        const e2 = new _c.TimerBean(), n2 = t.getCurrentInstance();
        return e2.vm = () => () => !n2.isUnmounted, e2;
      }), _c);
    });
  }
});
...
vue/dist/vue.cjs.js:
  ...
  **)
*/
//# sourceMappingURL=chunk-I34Z6B4L.js.map

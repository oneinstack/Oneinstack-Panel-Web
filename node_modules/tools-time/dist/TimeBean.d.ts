export default class TimeBean {
    ...
    constructor(options: TimeBeanParam);
    /**
     * 设置初始值
     */
...
export interface TimeProps {
     ...
     * 动画渲染前回调
     */
    updateBefore?: (bean: TimeBean) => any;
    /**
     * 动画渲染后回调
     */
    update?: (bean: TimeBean) => any;
    /**
     * 动画结束回调
     */
...
export type TimeBeanParam = TimeProps & TimeParam;
export {};

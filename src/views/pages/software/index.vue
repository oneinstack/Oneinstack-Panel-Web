...
const conf = reactive({
  dataTypelist: markRaw([
    ...
    {
      name: t("software.installed"),
      index: 1,
      component: InstalledSoft,
    },
    {
      name: t("software.upgradable"),
      index: 2,
      dot: false,
  ...
  tabs: {
    ...
    list: markRaw([
      ...
      {
        name: t("software.webServer"),
        index: 3,
      },
      {
        name: t("software.runEnv"),
        index: 4,
      },
      {
        name: t("software.utils"),
        index: 5,
      },
      {
        name: t("software.cloudStorage"),
        index: 6,
      },
      {
        name: t("software.model"),
        index: 7,
      },
    ]),
      ...
      >
        <div class="category flex justify-between items-center">
          <el-tabs
            ...
            @tab-click="conf.tabs.handleClick"
          >
            <el-tab-pane

    ...
    <div class="cu-modal-x">
      <div class="cu-dialog relative">
        ...
        <div class="row justify-center">
          <img class="showimg" src="/static/theme/blue/notice.svg" />
        </div>
        <div class="SystemBulletin-box">
          ...
          <div class="check">
            <van-checkbox
              v-model="conf.isNoPromptBulletin"
              icon-size="32rem"
              shape="square"
              @change="conf.isNoPromptBulletin = $event"
            >
              {{ $t('home.NoPrompt') }}
            </van-checkbox>
          </div>
...
import { index } from '@/views/home/home-com/DNotice'

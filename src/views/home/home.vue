<template>
  <x-page no-header tabbar>
    <div>
      ...
      <!-- 老虎机 -->
      <div class="lottery" v-if="conf.slotsGamesList.length">
        <div class="game-type-name2">
          <div class="flex flex-center">
            <img class="fbg1" src="/static/img/slots.png" style="width: 48rem; height: 37.5rem; margin-right: 10rem" />
            {{ $t('home.games') }}
          </div>
      ...
      <!-- 任务 -->
      <div class="task-box">
        <div class="content-view" @click="conf.goPage('/user/tasks/tasks', 2)">
          <img src="/static/img/home/home-task.png" class="task-img" mode="widthFix" />
          <div class="task-txt">
            <div class="txt1">{{ $t('home.taskTitle1') }}</div>
            <div class="txt2">{{ $t('home.taskTitle2') }}</div>
          </div>
...
import gamesBox from './home-com/gamesBox.vue'
...
import WinList from './home-com/winList.vue'

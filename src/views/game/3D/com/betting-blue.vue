		...
		<div class="betting">
			...
			<div class="betting-list between" :class="{ 'disabled': bconf.disabledShow }">
				<template v-for="item in sconf.list[0].sizeList" :key="item.oddsCode">
					<div class="type-item betting-tem" :class="{ 'active': item.isActive }"
						@click="conf.changeBet(item, 1)">
		...
		<div class="betting">
			...
			<div class="betting-list" :class="{ 'disabled': bconf.disabledShow }">
				<template v-for="item in sconf.list[0].poinits" :key="item.oddsCode">
					<div class="points-item betting-tem" :class="{ 'active': item.isActive }"
						@click="conf.changeBet(item, 2)">
		...
		<div class="betting">
			...
			<div class="betting-list between" :class="{ 'disabled': bconf.disabledShow }">
				<template v-for="item in sconf.list[0].singleList" :key="item.oddsCode">
					<div class="single-item betting-tem" :class="{ 'active': item.isActive }"
						@click="conf.changeBet(item, 3)">
		...
		<div class="betting">
			...
			<div class="betting-list between" :class="{ 'disabled': bconf.disabledShow }">
				<template v-for="item in sconf.list[0].pairList" :key="item.oddsCode">
					<div class="pair-item betting-tem" :class="{ 'active': item.isActive }"
						@click="conf.changeBet(item, 4)">
						<div class="pair-img">
		...
		<div class="betting">
			...
			<div class="betting-list between" :class="{ 'disabled': bconf.disabledShow }">
				<template v-for="item in sconf.list[0].tripleList" :key="item.oddsCode">
					<div class="triple-item betting-tem" :class="{ 'active': item.isActive }"
						@click="conf.changeBet(item, 5)">

			...
			<template v-for="(item, index) in conf.resultList" :key="index">
				<div class="result-ltem" v-if="item.openCode">
					...
					<div style="width: 31%;" class="share-point">
						<img class="point-img" :src="`/static/img/game/3d/d${conf.getNum(item, 0)}.png`" />
						<img class="point-img" :src="`/static/img/game/3d/d${conf.getNum(item, 1)}.png`" />
						<img class="point-img" :src="`/static/img/game/3d/d${conf.getNum(item, 2)}.png`" />
					</div>
				...
				<div class="result-ltem" v-else>
					...
					<div style="width: 31%;" class="share-point">
						...
						<div class="sum" style="margin: 0rem 6rem;">
							<img class="sum-img" src="/static/img/poinits.webp" />
							<div class="sum-num" style="font-weight: 700;">?</div>
						</div>
						<div class="sum">

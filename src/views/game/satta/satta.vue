<template>
    <GameLayout title="3DLottery" code="SATTA_KING" :lottery="lottery" :ref="conf.layout.setRef"
        ...
        <div class="col" style="overflow: auto;" ref="cRefs"
            ...
            <result ref="resultRefs" v-if="conf.operation.active === 'result'" :resultList="conf.his.result.list" :isTips="conf.page.isTips" @change="conf.page.nextPage" />

            <order ref="orderRefs" v-if="conf.operation.active === 'myOrder'"  :resultList="conf.his.order.list" :isTips="conf.page.isTips" @change="conf.page.nextPage" />

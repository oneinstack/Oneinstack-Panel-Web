<template>
	<div :class="{ 'loading': type != 3 }">
		...
		<div class="loadingio-spinner-ellipsis" v-else>
			<div class="ldio-list">
				<div class="ldio ldio1"></div>
				<div class="ldio ldio2"></div>
				<div class="ldio ldio3"></div>
				<div class="ldio ldio4"></div>
				<div class="ldio ldio5"></div>
			</div>
		</div>
	</div>
</template>

...
import threeD from './resultHistoryCom/3D.vue'
import winGo from './resultHistoryCom/winGo.vue'
import pk10 from './resultHistoryCom/pk10.vue'
import fiveD from './resultHistoryCom/5D.vue'
import color from './resultHistoryCom/color.vue'
import satta from './resultHistoryCom/satta.vue'
import lottery3D from './resultHistoryCom/lottery3D.vue'
import markSix from './resultHistoryCom/markSix.vue'
import animalsRunning from './resultHistoryCom/animalsRunning.vue'

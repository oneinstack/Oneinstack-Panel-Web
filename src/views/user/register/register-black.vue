    ...
    <div class="register-page">
      ...
      <div class="loginBox">
        <div class="content">
          <div class="otp">
            ...
            <div class="otp-item" v-if="conf.selectIndex == 1">
              ...
              <img
                ...
                src="/static/theme/black/login/eye-close.png"
              />
              <img v-else @click="conf.confirmEye = !conf.confirmEye" class="eye-img" src="/static/theme/black/login/eye-open.png" />
            </div>
            <!-- 手机号注册 -->
          ...
          <div class="check">
            <div v-if="!conf.checkedReceive" class="check-img"></div>
            <div v-else @click="conf.checkedReceive = !conf.checkedReceive" class="check-img check-active flex-center">
                <van-icon size="24rem" color="#232626" name="success" />
            </div>
            <div class="chenck-lable">I agree to the <span style="color: #fff;">User Agreement</span> & confirm I am at least 18 years old</div>
          </div>
          <div class="check">
            <div v-if="!conf.checkedAge" class="check-img"></div>
            <div v-else @click="conf.checkedAge = !conf.checkedAge" class="check-img check-active flex-center">
                <van-icon size="24rem" color="#232626" name="success" />
            </div>
            <div class="chenck-lable">I agree to receive marketing promotions from BG.GAME</div>
          </div>
          <div class="login-btn" @click="conf.passwordRegister" v-if="conf.selectIndex == 1">
            <greenBtn><span style="font-size: 32rem;">Sign Up</span></greenBtn>
          </div>
          ...
          <div class="tip">
            {{ $t('login.already') + '?' }}
            <div @click="System.router.replace('/login')">Sign in</div>
...
import BgImg from '@/views/user/login/components/blackImg.vue'

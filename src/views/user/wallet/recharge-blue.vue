              ...
              <div class="recharge-info">
                ...
                <div style="overflow-x: auto">
                  <div class="select-payment-view">
                    ...
                    >
                      <span class="methods-item">{{ item.payMethodName }}</span>
                    </div>
                  </div>
                </div>
                ...
                <div v-else>
                      ...
                      <div class="form-model">
                        ...
                        <div class="definition-view">
                          <input
                            class="uni-input fontsize"
                            type="text"
                            v-model="conf.bankCardInfo.bankCardNum"
                            disabled
                          />
                      ...
                      <div class="form-model">
                        ...
                        <div class="definition-view">
                          <input
                            class="uni-input fontsize"
                            type="text"
                            v-model="conf.bankCardInfo.bankBranch"
                            disabled
                          />
                  ...
                  <!-- 充值方式 == SCAN_CODE => 相关信息 -->
                  <template
                    v-if="conf.formData.payMethodCode == 'SCAN_CODE_PAYMENT' && conf.scanCodeInfo.scanCodePayImgUrl"
                  >
                  ...
                  >
                    ...
                    <span class="min-money">{{ ' ' + conf.infoObj.coinSymbol + conf.rechargeMinVal + ' ' }}</span>
                    {{ $t('rechargeModule.max') }}
                    <span class="min-money">{{ ' ' + conf.infoObj.coinSymbol + conf.rechargeMaxVal + ' ' }}</span>
                  </div>

export default {
    ...
    file: {
        ...
        linkDownload: 'URL Download',
        includeSubdir: 'Include subdirectory',
        searchPloaceholder:'Search for files/directories',
        uploadTo:'Upload files to',
        startUpload: 'Start upload',
        uploadText:'Drag the file/folder you want to upload here or',
        clickUpload:'Click upload file',
        notAllowUpload:'Cannot upload files directly to the system root directory!',
        linkPlaceholder: 'Paste or enter URL address here',
        downloadPlaceholder: 'Please select download path',
        fileNamePlaceholder: 'Please enter file name to save',
    ...
    commons: {
        ...
        rule: {
            ...
            role: 'Please enter valid permissions',

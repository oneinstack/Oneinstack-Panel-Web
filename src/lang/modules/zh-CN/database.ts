export default {
  ...
  phpMyAdmin: {
    ...
    versionDetail: '版本与详情',
    serviceTab: '服务',
    phpVersionTab: 'PHP 版本',
    securityTab: '安全设置',
    serviceTitle: '服务状态',
    serviceDescription: '查看安装状态并访问 phpMyAdmin 管理界面。',
    currentVersion: '当前版本',
    accessMode: '访问方式',
    panelProtected: '面板认证保护',
    accessPath: '访问路径',
    installHint: '安装完成后即可从面板安全访问 phpMyAdmin。',
    runtimeCompatibility: '运行环境与版本',
    runtimeCompatibilityDescription: '安装时会使用与当前 PHP 环境兼容的版本。',
    webServer: 'Web 服务器',
    targetVersion: 'phpMyAdmin 版本',
    selectVersion: '请选择版本',
    recommended: '推荐',
    versionSelectionHint: '已安装时版本由软件商城统一维护。',
    panelAccessTitle: '通过面板安全访问',
    panelAccessDescription: 'phpMyAdmin 入口由面板认证保护，不单独开放公共访问开关。',
    securityNoteLogin: '访问前需要先登录管理面板。',
    securityNotePublic: '不建议将 phpMyAdmin 直接暴露到公网。',
    securityNoteDatabase: '可从数据库列表直接进入对应数据库。'
  },
  security: {
  ...
  remote: {
    ...
    submitFailed: '保存远程数据库连接失败，请检查连接信息后重试',
    inputDatabaseAddress: '请输入数据库地址',
    inputPort: '请输入端口',
    inputUsername: '请输入用户名',
    keepPasswordPlaceholder: '留空表示保持现有密码',
    inputPassword: '请输入密码',
    emptyPrefix: '您的远程数据库列表为空，您可以',
    emptyAction: '添加一个远程数据库',

export default {
  ...
  logoutSuccess: '退出成功',
  runtimePrivilegeWarningTitle: 'Panel 未以 root 用户运行',
  runtimePrivilegeWarningMessage: '当前 Panel 可以继续使用，但部分系统级功能可能不可用。',
  runtimePrivilegeWarningDetail: '组件安装和维护、系统服务控制、Panel 更新、备份恢复以及网络配置通常需要 Linux root 权限。',
  task: '任务',
  runningTasks: '当前运行任务',
